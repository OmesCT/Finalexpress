...
jest.mock("../db/product", () => ({
  selectAll: jest.fn(() => Promise.resolve([
    { id: 1, name: "ชิณวัฒน์", nickname: "โอม", studentId: "6604101320", price: 1 }
  ])),
...
describe("Product Router", () => {
  it("should get all products", async () => {
    ...
    expect(response.body).toEqual({
      ID: "OK",
      result: [{ id: 1, name: "ชิณวัฒน์", nickname: "โอม", studentId: "6604101320", price: 1 }],
    });
  });

  it("should insert a new product", async () => {
    const newProduct = { id: 1, name: "ชิณวัฒน์", nickname: "โอม", studentId: "6604101320", price: 1 };
